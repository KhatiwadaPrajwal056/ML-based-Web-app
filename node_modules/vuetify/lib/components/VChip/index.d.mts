...
declare const VChip: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onClick:close"?: ((e: MouseEvent) => any) | undefined;
        }, "replace" | "link" | "filter" | "exact" | "label" | "style" | "draggable" | "disabled" | "size" | "tag" | "rounded" | "density" | "variant" | "modelValue" | "ripple" | "closable" | "closeIcon" | "closeLabel" | "filterIcon" | "pill">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
