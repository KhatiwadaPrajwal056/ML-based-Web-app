...
declare const VTabs: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onUpdate:modelValue"?: ((v: unknown) => any) | undefined;
        }, "symbol" | "height" | "direction" | "style" | "disabled" | "multiple" | "tag" | "mandatory" | "items" | "density" | "modelValue" | "selectedClass" | "stacked" | "grow" | "nextIcon" | "prevIcon" | "centerActive" | "hideSlider" | "alignTabs" | "fixedTabs">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
